...
const Create = () => {
        ...
        useEffect(() => {
                ...
                const userCreateData = () => {
                        ...
                        fetch(`https://hospital-backend-ibkd.vercel.app/info/userCreater`, {
        ...
        const UserInfo = async (e) => {
                ...
                const res = await fetch(`https://hospital-backend-ibkd.vercel.app/worker/userCreateImage`, { method: "POST", body: formData })
                ...
                const res2 = await fetch(`https://hospital-backend-ibkd.vercel.app/worker/userCreate`, { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify(worker) })
