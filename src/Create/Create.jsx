...
const Create = () => {
        ...
        const UserInfo = async (e) => {
                ...
                const res = await fetch(`${URL}/worker/userCreateImage`, { method: "POST", body: formData })
                ...
                const res2 = await fetch(`${URL}/worker/userCreate`, { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify(worker) })
